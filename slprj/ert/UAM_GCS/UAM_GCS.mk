...
## 
## Makefile     : UAM_GCS.mk
## Generated on : Fri Apr 25 10:09:25 2025
## Final product: ./UAM_GCS_rtwlib.lib
...
SRCS = $(START_DIR)/slprj/ert/UAM_GCS/UAM_GCS.c $(START_DIR)/slprj/ert/UAM_GCS/UAM_GCS_data.c
...
%.obj : $(START_DIR)/slprj/ert/UAM_GCS/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/UAM_GCS/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/UAM_GCS/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/UAM_GCS/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/UAM_GCS/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
UAM_GCS.obj : $(START_DIR)/slprj/ert/UAM_GCS/UAM_GCS.c
	$(CC) $(CFLAGS) -o "$@" "$<"


UAM_GCS_data.obj : $(START_DIR)/slprj/ert/UAM_GCS/UAM_GCS_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
