...
## Generated on : Fri Apr 25 10:14:19 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/UAM_Flight_control.exe
...
MODELREF_LINK_RSPFILE     = UAM_Flight_control_ref.rsp
COMPILER_COMMAND_FILE     = UAM_Flight_control_comp.rsp
CMD_FILE                  = UAM_Flight_control.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/UAM_Flight_control.exe
...
SRCS = $(START_DIR)/UAM_Flight_control_ert_rtw/UAM_Flight_control.c $(START_DIR)/UAM_Flight_control_ert_rtw/rtmodel.c
...
OBJS = UAM_Flight_control.obj rtmodel.obj
...
MODELREF_LIBS = C:/Users/USER/Desktop/onboard-flight-control-software-ver1.1-dev/slprj/ert/UAM_FlightMode/UAM_FlightMode_rtwlib.lib C:/Users/USER/Desktop/onboard-flight-control-software-ver1.1-dev/slprj/ert/UAM_GCS/UAM_GCS_rtwlib.lib C:/Users/USER/Desktop/onboard-flight-control-software-ver1.1-dev/slprj/ert/UAM_GuidanceAndNavigation/UAM_GuidanceAndNavigation_rtwlib.lib C:/Users/USER/Desktop/onboard-flight-control-software-ver1.1-dev/slprj/ert/UAM_Status/UAM_Status_rtwlib.lib
...
%.obj : $(START_DIR)/UAM_Flight_control_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/UAM_Flight_control_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/UAM_Flight_control_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/UAM_Flight_control_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/UAM_Flight_control_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
UAM_Flight_control.obj : $(START_DIR)/UAM_Flight_control_ert_rtw/UAM_Flight_control.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtmodel.obj : $(START_DIR)/UAM_Flight_control_ert_rtw/rtmodel.c
	$(CC) $(CFLAGS) -o "$@" "$<"
